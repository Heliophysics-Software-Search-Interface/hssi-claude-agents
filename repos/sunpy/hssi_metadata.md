...
- Source: Zenodo concept DOI (all versions), confirmed via CITATION.rst and DataCite API

### 3. Code Repository (MANDATORY)
- **URL:** https://github.com/sunpy/sunpy
- Source: Repository URL confirmed via PyHC registry, DataCite, and pyproject.toml
...
- Source: Determined from source code analysis of sunpy modules (coordinates/, image/, io/, map/, net/, physics/, sun/, timeseries/, visualization/). Coordinate Transforms:Mission-Specific from coordinates/spice.py (SPICE bridge). Data Visualization:Mission-Specific from visualization/colormaps/ (SDO/AIA, SOHO/EIT, Solar Orbiter, GOES-R/SUVI colormaps). Models and Simulations:Empirical from sun/models.py (differential rotation, solar interior models).
...
7. **Florian Mayer**
8. **V. Keith Hughitt** | ORCID: https://orcid.org/0000-0003-0787-9559 | Center for Cancer Research, National Cancer Institute
...
21. **Rishabh Sharma**
22. **Andrew Leonard** | ORCID: https://orcid.org/0000-0001-5270-7487 | Aperio Software Ltd.
...
38. **Michael S Kirk** | ORCID: https://orcid.org/0000-0001-9874-1429 | Catholic University of America & NASA Goddard Space Flight Center
39. **Michael Mueller**
40. **Sudarshan Konge**
...
55. **Himanshu**
56. **James Paul Mason** | ORCID: https://orcid.org/0000-0002-3783-5509 | Laboratory for Atmospheric and Space Physics, University of Colorado Boulder
57. **Sanskar Modi**
...
72. **Johan Freiherr von Forstner** | ORCID: https://orcid.org/0000-0002-1390-4776 | Institut für Experimentelle und Angewandte Physik, University of Kiel
...
119. **Nick Murphy** | ORCID: https://orcid.org/0000-0001-6628-8033 | Center for Astrophysics | Harvard & Smithsonian
120. **Rutuja Surve**
121. **Samuel Jackson**
...
146. **Priyank Lodha**
147. **Samuel J. Van Kooten** | ORCID: https://orcid.org/0000-0002-4472-8517 | Southwest Research Institute
148. **Shivansh Mishra**
...
223. **OussCHE**
224. **Paul J. Wright** | ORCID: https://orcid.org/0000-0001-9021-611X | Dublin Institute for Advanced Studies
225. **Prisha Sharma**
...
- Source: Derived from pyproject.toml description and README

### 10. Publication Date (RECOMMENDED)
- **Publication Date:** 2011-08-06
- Source: GitHub repository creation date via SoMEF (date_created)
...
- Python 3.x
- C
- Source: pyproject.toml classifiers, SoMEF, GitHub language statistics

### 14. Reference Publication (RECOMMENDED)
- **DOI:** https://doi.org/10.3847/1538-4357/ab4f7a
- Title: "The SunPy Project: Open Source Development and Status of the Version 1.0 Core Package" (The Astrophysical Journal, 2020)
- Source: CITATION.cff and CITATION.rst

### 15. License (RECOMMENDED)
- **License:** BSD 2-Clause "Simplified" License
- **License URI:** https://spdx.org/licenses/BSD-2-Clause
- Source: LICENSE.rst file text (2-clause BSD), confirmed by .zenodo.json (BSD-2-Clause) and DataCite API. Note: pyproject.toml lists BSD-3-Clause but the actual LICENSE.rst text contains only 2 clauses.
...
- astropy
- wcs
- Source: Combined from pyproject.toml keywords, PyHC registry keywords, SoMEF GitHub topics, and DataCite subjects

### 17. Data Sources (OPTIONAL)
- The Virtual Solar Observatory
- CDAWeb
- Observatory/Mission-specific
- Source: sunpy.net modules (vso/, cdaweb/, jsoc/, dataretriever/, hek/, helio/, solarnet/)
...
- ascii
- Other
- Source: sunpy.io module (_fits.py, _cdf.py, _jp2.py, ana.py, special/asdf/, special/genx.py, special/srs.py); timeseries dependencies (h5netcdf, cdflib, h5py). "Other" covers JPEG2000, ANA, ASDF, GenX, and SRS formats.
...
- ascii
- Other
- Source: sunpy.io module write capabilities. "Other" covers JPEG2000, ANA, and ASDF formats.

### 20. Operating System (RECOMMENDED)
- Linux
- Mac
- Windows
- Source: CI/CD configuration (.github/workflows/ci.yml tests on linux, macos, windows); pyproject.toml classifier "Operating System :: OS Independent"

### 21. CPU Architecture (RECOMMENDED)
- x86-64
- Apple Silicon arm64
- Source: CI tests run on standard GitHub runners (x86-64 Linux/Windows, Apple Silicon macOS)
...
- Solar Flares
- X-ray emission
- Source: SunPy handles GOES X-ray flux data (solar flares, X-ray emission), SOHO/LASCO and STEREO data (CMEs), and general coronal imaging data. HEK module queries solar event databases including coronal hole (CH) events.
...
- Source: PyHC registry, pyproject.toml project URLs, README.rst, SoMEF

### 25. Funder (OPTIONAL)
- **Organization:** NumFOCUS
- **Funder Identifier:** https://ror.org/004eyxv41
- Source: README.rst "Powered by NumFOCUS" badge. SunPy is a NumFOCUS fiscally sponsored project.
...
- https://doi.org/10.1088/1749-4699/8/1/014009 — "SunPy—Python for solar physics" (2015, first paper describing sunpy v0.5)
- https://doi.org/10.21105/joss.01832 — JOSS review of sunpy v1.0.8 (Mumford et al. 2020)
- https://doi.org/10.3389/fspas.2023.1076726 — "The SunPy Project: An interoperable ecosystem for solar data analysis" (The SunPy Community 2023, Frontiers in Astronomy and Space Sciences)
- Source: CITATION.rst other publications section

### 28. Related Datasets (OPTIONAL)
Not found

### 29. Related Software (OPTIONAL)
- https://github.com/astropy/astropy — astropy (core dependency for coordinates, units, FITS I/O)
- https://github.com/sunpy/ndcube — ndcube (N-dimensional data handling for SunPy)
- https://github.com/sunpy/sunpy-sphinx-theme — SunPy documentation theme
- Source: pyproject.toml dependencies and SunPy ecosystem

### 30. Interoperable Software (OPTIONAL)
- https://github.com/astropy/astropy — astropy (core framework, coordinates, units)
- https://github.com/sunpy/ndcube — ndcube (N-dimensional astronomical data)
- https://github.com/JSOC-SDP/drms — drms (JSOC data access)
- Source: pyproject.toml dependencies and demonstrated interoperability

### 31. Related Instruments (OPTIONAL)
Not found - SunPy supports many instruments via its map and timeseries sources but does not target specific instrument identifiers.
...
- Source: sunpy.map.sources/ and sunpy.timeseries.sources/ module files (sdo.py, soho.py, stereo.py, goes.py, hinode.py, iris.py, psp.py, solo.py, proba2.py, punch.py, rhessi.py, fermi_gbm.py, trace.py, yohkoh.py, gong.py, suit.py, asos.py, mlso.py)
